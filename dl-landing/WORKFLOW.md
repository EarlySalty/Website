...
## /szene/ entfernt (2026-08-22)

Die lebende Seite `/szene/` wurde am 22.08.2026 wieder entfernt; der Blogpost
`blog/twitch-szene-2026/` bleibt als Stichtags-Report stehen. Die
Zeichenfunktionen in `src/charts.js` werden weiterhin von der
Transparenz-Seite und dem Blogpost gemeinsam genutzt.

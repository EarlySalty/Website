## #74 — Transparenz-Seite: Beweistabelle zur Bot-Bereinigung entfernt

**Ausgangslage:** Kapitel 1 enthielt eine ausführliche Gegenüberstellung, warum 842 Konten aus der Mitgliederzahl herausgerechnet werden — mit eigener Tabelle, Prozentwerten und Erläuterung. Das unterbrach den Lesefluss an einer Stelle, an der es um die Community geht, nicht um Methodik. **Änderung:** Der Block ist raus. Die Begründung steht jetzt kompakt im Kleingedruckten am Seitenende, wo auch alle anderen Erhebungsfragen beantwortet werden. **Aktuelles Verhalten:** Kapitel 1 liest sich in einem Zug; wer wissen will, wie die Bereinigung zustande kommt, findet es unter „Wie die Zahlen entstanden sind".

## #73 — Transparenz-Seite: eigene Stimme, klarere Rollen, Ausblick statt nur Bestandsaufnahme

**Ausgangslage:** Die Seite las sich distanziert, als hätte sie jemand von außen geschrieben. Außerdem waren zwei Rollen falsch eingeordnet — „Content Creator" ist eine reine Funktionsrolle und VIPs sind aktive Langzeit-Mitglieder, keine Geldgeber. Und es fehlte der wichtigste Teil: was mit mehr Zeit und Geld eigentlich entstehen soll, statt immer nur zu reparieren. **Änderung:** Die Kapiteltexte sind jetzt in der Ich-Form geschrieben. Die Rollenübersicht unterscheidet sauber zwischen Aufgabe, Streaming, langjähriger Aktivität und finanzieller Unterstützung. Neu ist ein Kapitel mit den konkreten Vorhaben — Coaching mit nachlesbaren Lektionen, neue Website, regelmäßige Turniere mit Preisgeld, mehr für die Streamer, Doku, Unterstützung für die Scrim-Coaches. Das Hilfe-Kapitel ist von vier auf acht Punkte gewachsen und nennt jetzt auch Videos, Grafik und Hilfe für Neueinsteiger. **Aktuelles Verhalten:** Zehn Kapitel, klare Trennung zwischen Zahlen und Einschätzung, und am Ende steht, wobei konkret geholfen werden kann.

## #72 — Transparenz-Seite: Mitgliederzahl bereinigt, Zeit und Beteiligung ergänzt

**Ausgangslage:** Die Seite nannte 2.428 Mitglieder — die Zahl, die auch Discord anzeigt. Darin steckten aber 842 Konten aus fünf Bot-Wellen, die nie etwas getan haben. Außerdem zeigte die Seite zwar Commits, aber nicht, wie viel Zeit dahintersteckt und wer sich sonst beteiligt. **Änderung:** Alle Mitglieder-, Sprach- und Onboarding-Zahlen sind jetzt um die Bot-Zuflüsse bereinigt, mit offengelegter Erkennungsregel und Gegenprobe. Neu dazugekommen sind zwei Kapitel: die geschätzte Arbeitszeit über die Zeit samt Aufteilung nach Projekt, sowie eine Aufstellung, wer welche Aufgabe trägt, wer unterstützt und wer welche Verantwortung hält. **Aktuelles Verhalten:** Die Seite nennt 1.586 statt 2.428 Mitglieder und begründet den Unterschied nachprüfbar. Korrigiert wurden außerdem die Twitch-Zahlen: genannt werden jetzt nur Partner-Streams statt aller beobachteten Kanäle, Bits ohne die doppelt erfassten Ereignisse und Raids nur, soweit erfolgreich.
...
**Geändert:** Die Anmeldung läuft über die Website: Rang mit Unterstufe, Lane und die Zeiten, an denen du kannst — direkt in einem Wochenraster statt als Fließtext. Die Zeiten sind Pflicht, denn daran rechnen wir aus, wann dein Team gemeinsam kann. Wer sich anmeldet oder im Ankündigungskanal mit dem Haken reagiert, bekommt die Scrim-Rolle automatisch und sieht die Kanäle sofort. Beim Veröffentlichen setzt der Bot diesen Haken direkt selbst, damit niemand erst das Emoji suchen muss. Ganz oben steht jetzt, worauf du dich einlässt: zwei bis drei Mal die Woche Training im Team, alle ein bis zwei Wochen ein Inhouse.

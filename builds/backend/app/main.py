...
from app.routers import auth, heroes, builds, items, tierlists, patchnotes, history, admin, coaching, coaching_platform
...
app.include_router(coaching_platform.router, prefix="/api/coaching", tags=["coaching-platform"])

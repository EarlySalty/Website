...
export default function CoachDetailPage() {
  ...
  if (!coach) {
    return (
      <div className="content-grid py-10">
        ...
        <Link to="/coaching/coaches" className="mt-4 text-accent-violet hover:underline">
          ← Zurück zu Coaches
        </Link>
      </div>
    )
  ...
  return (
    <div className="content-grid py-10 md:py-14">
      {/* Back */}
      <Link to="/coaching/coaches" className="inline-block mb-6 text-sm text-slate-400 hover:text-white">
        ← Zurück zu Coaches
      </Link>

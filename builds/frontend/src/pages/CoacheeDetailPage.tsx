...
export default function CoacheeDetailPage() {
  ...
  if (!data?.profile) {
    return (
      <div className="content-grid py-10">
        ...
        <Link to="/coaching/dashboard" className="mt-4 inline-block text-accent-violet hover:underline">
          ← Zum Dashboard
        </Link>
      </div>
    )
  ...
  return (
    <div className="content-grid py-10 md:py-14">
      <Link to="/coaching/dashboard" className="mb-6 inline-block text-sm text-slate-400 hover:text-white">
        ← Zum Dashboard
      </Link>
